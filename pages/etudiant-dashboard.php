        ...
        <div class=" col-xl-9 col-sm-12">
            <div class="intro p-4 mt-3 d-flex align-items-center">
                <h3><b>Bonjour
                        ...
                        ?>
                    </b></h3> <img style="margin-left: 15px; width:40px ;" src="./../assets/icon/salute-icon.png"
                                   alt="">
            ...
            <div class="cv" hidden>
                ...
                echo $etudiant_info['CV_ETU'] ?>" id="cv">
            </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-2 p-2 border border-1 rounded-3 ">
                                            <div>
                                                <div class=" p-3 ">
                                                    ...
                                                    <div>
                                                        <input class="form-control d-none" name="cvPath"
                                                               id="pathStorageFile">

                                                        <input type="text" name="cne"
                                                               value="<?php echo $_SESSION['auth'] ?>" hidden id="">
                                                        <input type="text" id="noffre" name="noffr" hidden>

                                                        <div class="row mt-2 d-flex justify-content-around ">
                                                            <div style="width: fit-content"
                                                                 class="mt-2 ms-3 col-6 px-5 py-4  d-flex flex-column rounded-4 justify-content-center ">
                                                                ...
                                                                <input class="form-control d-none" name="cv"
                                                                       onchange="uploadFileToFirebase('fileCv','btnSubmit','pathStorageFile',2,'<?php echo $_SESSION['auth'] ?>')"
                                                                       accept="application/pdf" type="file" id="fileCv">
                                    ...
                                    <div class="row ms-4">
                                        <div class="col-xl-6  mt-4">
                                            <button type="submit" name="filesUploaed" id="btnSubmit"
                                                    value="uploadCvPostuler"
                                                    class="btn btn-filtre btn-primary w-100 mb-3"> Enregistrer <i
            ...
            <div class="modal-content d-flex justify-content-center " style="max-width: 800px;margin:auto;">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <form action="etudiant-dashboard.php" name="cvupload" method="post"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="row mt-2 d-flex justify-content-around ">
                                                                <div class="mt-2 ms-3 col-xl-6 px-5 py-4  d-flex flex-column justify-content-center ">
                                                                    <button type="submit" name="btnOffre"
                                                                            value="uploadCvPostuler"
                                                                            class="btn btn-filtre btn-primary  mb-3">
                                                                        Postuler <i class="bi bi-plus-circle-fill"></i>
                                                                    </button>
