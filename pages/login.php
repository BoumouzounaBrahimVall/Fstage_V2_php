...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100&family=Reem+Kufi&display=swap" rel="stylesheet">
                ...
                <div class="tab-pane  active" id="pills-etudiant" role="tabpanel" aria-labelledby="tab-login">
                    <form  class="col-md-auto mb-3" method="post">
                            ...
                            <div class="btn-login-parent">
                              <button type="submit" class="btn btn-primary btn-login " id="btn-seconnecter-body">Se connecter</button>
                            </div>
