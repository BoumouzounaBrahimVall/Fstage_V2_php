            ...
            <div class=" col-xl-8 p-4   col-sm-12 mt-0">
              ...
              <div class="row  px-4 mt-2">
                ...
                <div class="col p-4 mr-2 ">
                 ...
                 ?></h1>
                        <input id="formationId" type="text" class="d-none" value="<?php echo $numFormation ;?>">
                ...
                <div class="row  p-4 mt-2">
                    <div class="col-xl-6 col-sm-12 mx-auto">
                        <select id="selectedOption" onchange="showGraph()" class="form-select" aria-label="Default select example">
                    ...
                    function (data)
                    {
                        ...
                        switch (dataX.option)
                        {
                            case '1':{
                                ...
                                chartRep.column=["Offres", "Etudiants","Enseignant"];break;
                            }
                            case '2':{
                                chartRep.backgroundColor= [
                                    ...
                                    chartRep.column=["Nouveaux", "Complété"];break;
                            }
                            case '3':{
                                chartRep.backgroundColor= [
                                    ...
                                    chartRep.borderWidth=[ 1,1],
                                    chartRep.column=["Compte Activé", "Compte Desactivé"];break;
                            }
                            case '4':{
                                chartRep.backgroundColor= [
