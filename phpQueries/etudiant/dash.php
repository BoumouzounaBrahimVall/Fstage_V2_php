...
function genererContrat($etudiant_cne,$bdd,$niveau,$etudiant_info){
...
$pdf->Output('F','../ressources/EtudiantCONTRAT/'.$etudiant_info['CNE_ETU'].''.$niveau.''.$info_stg_etu['NUM_STG'].'.pdf');
}
